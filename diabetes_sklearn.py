"""
This module explores the Diabetes dataset using scikit-learn.
It trains a K-Nearest Neighbors (KNN) regressor to predict
diabetes progression based on various features, and produces a heatmap 
revealing correlations between patient feature and disease progression.
"""
